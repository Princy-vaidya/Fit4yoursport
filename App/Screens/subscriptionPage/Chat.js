        ...
        >
            ...
            <View style={styles.chatView}>
                ...
                <View style={{ flexDirection: 'row', width: '50%', alignItems: 'center' }}>
                    <Image 
                    source={route.params.chat.userDetails.profile_image === null || route.params.chat.userDetails.profile_image===''?
                    require('../../Assets/Auths/user.png'):{uri:'https://fit4yoursport.dk:1446/'+route.params.chat.userDetails.profile_image}}
                        style={styles.profilepic} />
                    <Text style={styles.name}>
                        {route.params.chat.userDetails.fname + ' ' + route.params.chat.userDetails.lname}
                    </Text>
                ...
                <TouchableOpacity style={{ alignItems: 'flex-end', width: '50%' }}
                    onPress={() => navigation.navigate('VideoCallTrainer', { userId: route.params.chat.userDetails._id })}>
